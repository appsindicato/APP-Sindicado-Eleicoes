...
<form  id="formVotar" action="votar-municipal" method="post" onsubmit="votar();return false;" autocomplete="off">
	...
	<div class="form-group">
		<input type="text" id="nr1" name="nr1" required autocomplete="off" maxlength="1"  onkeyup="carregarChapa(); return nextInput(event)" autofocus>
		<input type="text" id="nr2" name="nr2" required autocomplete="off" maxlength="1"  onkeyup="carregarChapa(); return nextInput(event)">
		<input type="text" id="nr3" name="nr3" required autocomplete="off" maxlength="1"  onkeyup="carregarChapa(); return nextInput(event)">
	</div>
	<div class="btn-group">
